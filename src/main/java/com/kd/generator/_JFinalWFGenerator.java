 ...
 */
public class _JFinalWFGenerator {
...
//		String password = PropKit.use("config.properties").get("password");
		String url = "jdbc:mysql://10.47.113.150/peseer_online?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
		String username = "root";
		String password = "password";

		DruidPlugin c3p0Plugin = new DruidPlugin(url, username, password);
		c3p0Plugin.start();
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.kd.model.general.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com/kd/model/general/base";

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.kd.model.general";
		// model 文件保存路径 (MappingKit 与 DataDictionary 文件默认保存路径)
		String modelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com/kd/model/general";
